...
class TidyUpDish(BaseEnv):
    ...
    def _add_workspace(self):
        ...
        sink.set_pose(sapien.Pose(p=[-1.058, 0.019, -0.0096],q=[0.707, 0, 0, -0.707]))
        pass
    ...
    def _add_actor(self):
        ...
        kitchen_table.set_pose(sapien.Pose(p=[0.30, 0.91, -1.0],q=[0.707, 0, 0, -0.707]))
        ...
        for i in range(2):
            ...
            dishes.set_pose(sapien.Pose(p=[-1.057, 0.031, 0.006+0.1*i],q=[-0.291, 0, 0, 0.957]))
